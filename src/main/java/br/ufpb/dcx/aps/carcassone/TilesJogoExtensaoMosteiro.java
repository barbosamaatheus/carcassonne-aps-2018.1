...
public class TilesJogoExtensaoMosteiro extends TipoTileCarcassonne {
	
	private boolean jardim;
	
	public TilesJogoExtensaoMosteiro(Origem origem, TipoLado ladoNorte, TipoLado ladoLeste, TipoLado ladoSul, TipoLado ladoOeste,
