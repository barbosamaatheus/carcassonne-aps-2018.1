...
public interface TilesJogoBase {
	...
	TipoTile RRRRJ50 = new TilesJogoExtensaoMonasterio(BASE, ESTRADA, ESTRADA, ESTRADA, ESTRADA, SEM_ESCUDO, SEM_MOSTEIRO,SEM_CIDADES, COM_JARDIM);
	...
	Tile t48 = new Tile("48", FFFFL50); //Mosteiro
	Tile t49 = new Tile("49", FFRFL50); //Mosteiro
	...
	Tile t73 = new Tile("73", RRRRJ50); //jardim
